            ...
            <div class="collapse navbar-collapse" id="mainNav">
                    ...
                    <?php if ($user): ?>
                        ...
                        <?php if ($isAdmin): ?>
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link <?= $active === 'meciuri' ? 'active' : '' ?>" href="meciuri.php">Meciuri</a>

                            </li>

                            <li class="nav-item">

                                <a class="nav-link <?= $active === 'grupe' ? 'active' : '' ?>" href="grupe.php">Grupe</a>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link <?= $active === 'clasament' ? 'active' : '' ?>" href="clasament.php">Clasament</a>

                        </li>

                        <li class="nav-item">

                            <a class="nav-link <?= $active === 'program' ? 'active' : '' ?>" href="program.php">Program</a>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <?php if ($user): ?>
                        ...
                        <span class="text-white small"><?= escape_html($user['nume'] . ' ' . $user['prenume']) ?> (<?= escape_html($user['role']) ?>)</span>
