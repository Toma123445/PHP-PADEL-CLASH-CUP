...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!check_rate_limit('login_' . $ip, MAX_LOGIN_ATTEMPTS, LOGIN_LOCKOUT_TIME)) {

        flash('danger', 'Prea multe încercări de autentificare. Te rugăm să aștepți 15 minute.');
    ...
    // Reset rate limit counter după autentificare reușită
